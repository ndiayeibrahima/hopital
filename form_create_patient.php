...
<body>
  ...
  <div class="panel panel-primary " style="margin-top: 60px;">
    <div class="panel-heading">Entregistrement d'un Patient</div>
    ...
    <form method="post" action="create_employe.php" class="form" style="height:90%" >
      ...
      <input type="text" name="nom" placeholder="nom Patient" class="form-control" required="required" max-length="20">
