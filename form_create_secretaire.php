...
<body>
  ...
  <div class="panel panel-primary " style="margin-top: 60px;">
    <div class="panel-heading">Entregistrement d'un Secretaire</div>
    <div class="panel-body">
    <form method="post" action="create_secretaire.php" class="form" style="height:90%" >
      

      
      <div class="form-group">
      <label for="nom">nom:</label>
      <input type="text" name="nom" placeholder="nom Secretaire" class="form-control" required="required" max-length="20">
